...
namespace Plingy.Controllers
{
    public class StudentController : Controller
    {
        ...
        public StudentController(PlingyDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentID,Name,JoinDate,ActiveStudent,Address")] Student student)
        {
